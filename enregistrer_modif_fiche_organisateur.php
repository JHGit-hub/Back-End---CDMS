...
rôle : enregistrer les modifications apportés à la fiche organisateur
paramétre: 
...
////// Traitement:
// On instancie les classes organizer et user
$organizer = new Organizer($user_id);
$user = new User($id);

// On charge les nouvelles valeurs issu du formulaire
$organizer->loadFromTab($_POST);
...
if ($organizer->update() && $user->update()) {
    // La mise à jour à réussi : on affiche la page fiche_organisateur.php avec les modifications
